...
const ProductCard = ({imgUrl, nombreProducto, precioProducto}) => {
return (
  
   <div class="relative max-w-sm min-w-[340px] bg-white shadow-md rounded-3xl p-2 mx-1 my-3 cursor-pointer">
      <div class="overflow-x-hidden rounded-2xl relative">
        <img class="h-40 rounded-2xl w-full object-cover" src={imgUrl}></img>
      ...
      <div class="mt-4 pl-2 mb-2 flex justify-between ">
        <div>
          <p class="text-lg font-semibold text-gray-900 mb-0">{nombreProducto}</p>
          <p class="text-md text-gray-800 mt-0">{precioProducto}</p>
        </div>
