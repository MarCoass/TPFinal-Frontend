...
export default function DatosUsuario() {
    ...
    const validateForm = () => {
        ...
        // Validar nombre
        if (nombre.length < 3) {
            validationErrors.nombre = "El usuario debe tener al menos 3 caracteres.";
        }

        // Validar apellido
        if (apellido.length < 3) {
            validationErrors.apellido = "El usuario debe tener al menos 3 caracteres.";
        }
        ...
        if (password !== passwordConfirmation) {
            ...
            validationErrors.passwordConfirmation ="Las contraseñas no coinciden.";
        }
    ...
    const submitForm = async event => {
        ...
        if (validationErrors.length > 0) {
            ...
            //     num_telefono: userData.numTelefono,
            ...
            //     await updateUserProfile(userDataToSubmit);
            // } else {
